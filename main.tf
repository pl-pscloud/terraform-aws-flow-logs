...
resource "aws_iam_role" "pscloud-iam-role-for-flow-log" {
  name = var.pscloud_vpc_id != null ? "${var.pscloud_company}_iamrole_flowlog_${var.pscloud_vpc_id}_${var.pscloud_env}_${var.pscloud_project}" : "${var.pscloud_company}_iamrole_flowlog_${var.pscloud_subnet_id}_${var.pscloud_env}_${var.pscloud_project}"
...
resource "aws_iam_role_policy" "pscloud-iam-policy-for-cloudwatch-log" {
  ...
  name = var.pscloud_vpc_id != null ? "${var.pscloud_company}_iampolicy_cloudwatch_${var.pscloud_vpc_id}_${var.pscloud_env}_${var.pscloud_project}" : "${var.pscloud_company}_iampolicy_cloudwatch_${var.pscloud_subnet_id}_${var.pscloud_env}_${var.pscloud_project}"
